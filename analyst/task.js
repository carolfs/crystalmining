...
window.onload = function() {
    ...
    preload_images(
        "/crystalmining/analyst/img/astronaut_small.png",
        "/crystalmining/analyst/img/crystals.jpg",
        "/crystalmining/analyst/img/planet.png",
        "/crystalmining/analyst/img/spaceship.png",
        "/crystalmining/analyst/img/ticket.png",
        "/crystalmining/analyst/img/page_next.png",
        "/crystalmining/analyst/img/page_previous.png",
        "/crystalmining/analyst/img/greeting_astronaut.png",
        "/crystalmining/analyst/img/sky.png",
        "/crystalmining/analyst/img/sky_planet.png",
        "/crystalmining/analyst/img/crystal_profit.jpg",
        "/crystalmining/analyst/img/arrow_collect.png",
        "/crystalmining/analyst/img/arrow_discard.png",
        "/crystalmining/analyst/img/arrow_score.png",
        "/crystalmining/analyst/img/arrow_bonus.png",
        "/crystalmining/analyst/img/arrow_bonus_prediction.png",
        "/crystalmining/analyst/img/auditor.png",
        "/crystalmining/analyst/img/crystal1.jpg",
        "/crystalmining/analyst/img/crystal2.jpg",
        "/crystalmining/analyst/img/crystal3.jpg",
        "/crystalmining/analyst/img/crystal4.jpg",
        "/crystalmining/analyst/img/crystal5.jpg",
        "/crystalmining/analyst/img/crystal6.jpg",
        "/crystalmining/analyst/img/miner1.png",
        "/crystalmining/analyst/img/miner2.png",
        "/crystalmining/analyst/img/miner3.png",
        "/crystalmining/analyst/img/miner4.png",
        "/crystalmining/analyst/img/miner5.png",
        "/crystalmining/analyst/img/miner6.png",
        "/crystalmining/analyst/img/miner7.png",
        "/crystalmining/analyst/img/miner8.png",
        "/crystalmining/analyst/img/miner9.png",
        "/crystalmining/analyst/img/miner10.png",
        "/crystalmining/analyst/img/crystal_collect.png",
        "/crystalmining/analyst/img/crystal_points.png",
        "/crystalmining/analyst/img/crystals_unique.png",
        "/crystalmining/analyst/img/disable_mining.png",
        "/crystalmining/analyst/img/space_start.png",
        "/crystalmining/analyst/img/spaceship_flying.png",
        "/crystalmining/analyst/img/zyxlon.jpg",
        "/crystalmining/analyst/img/own_prediction.png",
        "/crystalmining/analyst/img/crystal5_predict.png",
        "/crystalmining/analyst/img/colleague_prediction.png",
        "/crystalmining/analyst/img/own_prediction_results.png",
        "/crystalmining/analyst/img/ecocrd.png",
        "/crystalmining/analyst/img/mini_game.png",
        "/crystalmining/analyst/img/colleague_prediction_results.png",
        "/crystalmining/analyst/img/quiz_correct.png",
        "/crystalmining/analyst/img/quiz_incorrect.png",
    );
